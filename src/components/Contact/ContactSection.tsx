            ...
            <div className="mx-auto max-w-2xl text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
                    ...
                    <a
                        ...
                        className="glass glass-hover flex items-center gap-3 rounded-full px-6 py-3 transition-all"
                    >
                ...
                {/* Status */}
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/5 text-sm text-white/40">
